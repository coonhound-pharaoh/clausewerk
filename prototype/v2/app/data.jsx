...
const SAMPLE_INTAKES = [
  "We're onboarding Northwind Analytics to run analytics on our European customer data. Annual spend is around $240K and it'll be a production workload.",
  "Contracting a boutique agency for a one-off marketing campaign. $18K flat fee, no data access, 6-week engagement.",
  "Renewing with our core payroll SaaS — processes employee PII across US and Canada, mission-critical, $480K/yr, likely offshore subcontractors.",
  "Evaluating a white-label AI vendor where we'd resell their platform under our brand. Expect derivative works and source-level customization.",
];
